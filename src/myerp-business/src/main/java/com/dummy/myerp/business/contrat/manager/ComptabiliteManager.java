...
public interface ComptabiliteManager {
    ...
    /**
     * Ajoute une référence à l'écriture comptable.<strong>RG_Compta_5 :
     * </strong>
     * La référence d'une écriture comptable est composée du code du journal
     * dans lequel figure l'écriture suivi de l'année et d'un numéro de séquence
     * (propre à chaque journal) sur 5 chiffres incrémenté automatiquement à
     * chaque écriture. Le formatage de la référence est : XX-AAAA/#####.
     * <br>
     * Ex : Journal de banque (BQ), écriture au 31/12/2016
     * <pre>BQ-2016/00001</pre>
     *
     * <p>
     * <strong>Attention :</strong> l'écriture n'est pas enregistrée en
     * persistance</p>
     *
     * @param pEcritureComptable L'écriture comptable concernée
     * @throws FunctionalException si ...
     */
    ...
    /**
     * Renvoie une séquence d'écriture comptable en fonction de son année et du
     * code du journal.
     *
     * @param pAnnee
     * @param pJournalCode
     ...
     */
    SequenceEcritureComptable getSequenceByYearandJournalCode(Integer pAnnee, String pJournalCode) throws Exception;

    /**
     * Insert une séquence d'écriture comptable.
     *
     ...
     */
    void updateSequenceEcritureComptable(SequenceEcritureComptable vNouvSequenceEcriture);
}
